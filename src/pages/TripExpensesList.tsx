  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [expRes, tripRes, headRes] = await Promise.all([
        ...
        supabase
          .from('trips')
          .select('trip_id, trip_number, trip_status, vehicles(vehicle_number), routes(origin_city, destination_city), freight_revenue')
  ...
  if (tripGroups.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-gray-500 font-medium">No trip expenses found</p>
        <p className="text-sm text-gray-400 mt-1">Add expenses to trips to see them grouped here</p>
      </div>
    );
  }
      ...
      {tripGroups.map(({ trip, expenses }) => {
        ...
        return (
          <div key={trip.trip_id} className="group/trip">
            ...
            >
              <div className="shrink-0 text-gray-400 transition-transform">
              ...
              <div className="flex items-center gap-4 shrink-0">
                ...
                <button
                  ...
                  className="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors opacity-0 group-hover/trip:opacity-100"
