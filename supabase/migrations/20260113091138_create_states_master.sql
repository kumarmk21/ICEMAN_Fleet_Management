/*
  ...
  This table will be used for address management, billing, and GST compliance.
  ...
  ## Notes
  - Pre-populated with all 28 states and 8 union territories of India
  - GST state codes as per Indian GST regulations
  - Includes state abbreviations for quick reference
*/
